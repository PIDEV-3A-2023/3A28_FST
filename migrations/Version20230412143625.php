 ...
 */
final class Version20230412143625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cartitem (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, panier_id INT NOT NULL, quantity INT NOT NULL, price DOUBLE PRECISION NOT NULL, UNIQUE INDEX UNIQ_62602FA7F347EFB (produit_id), INDEX IDX_62602FA7F77D927C (panier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE shoppingcart (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenoom VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, adresse VARCHAR(600) NOT NULL, code_postale INT NOT NULL, order_date DATE NOT NULL, total_price DOUBLE PRECISION NOT NULL, sta VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
